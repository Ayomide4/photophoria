...
export default function About() {
  return (
    <div className="flex flex-col items-center bg-background md:mt-20 lg:mx-5 lg:mt-28">
      {/* <h1 className="font-museo-moderno font-bold text-3xl md:hidden md:text-5xl md:mb-8"> */}
      {/*   About Us */}
      {/* </h1> */}
      <div className="w-full flex flex-col items-center mb-[110px] md:flex-row-reverse md:h-[65vh]">
        ...
        <div className="w-full relative rounded-[30px] bg-secondary p-4 md:h-full md:w-[60%] md:rounded-3xl ">
          ...
          <div className=" lg:p-10">
            {" "}
            <h2 className="font-bold text-2xl/8 mb-4 md:text-3xl  lg:text-4xl  xl:mb-8">
              Photo Booth Rentals for Unforgettable Moments
            </h2>
            <p className="text-lg mb-2 md:mb-6 lg:text-xl lg:mb-6 xl:text-2xl">
            ...
            <p className="text-lg mb-2 hidden md:block md:mb-10 lg:text-xl xl:text-2xl">
      ...
      <div className="w-full h-96 relative rounded-full mb-20 lg:h-[700px]">
        <Video
          videoSrc="/assets/photophoria2.3.mp4"
          className=" rounded-[30px]"
        />
      </div>
      <div className="w-full mb-20  lg:w-4/5">
        <h2 className="font-museo-moderno text-xl text-center mb-8 md:text-2xl ">
          Our Core Values
        </h2>
        <CoreValues />
      </div>
      <div className="w-full h-96 relative rounded-full mb-10 lg:h-[700px]">
        <Video
      ...
      <Link
        href="/contact"
        className="bg-primary text-black text-xl font-bold rounded-full px-4 py-4 mt-2 w-full flex items-center justify-center h-12 mb-10 md:w-52 lg:w-72"
      >
        Book Now
      </Link>{" "}
    </div>
